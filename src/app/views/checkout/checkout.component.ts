...
export class CheckoutComponent implements OnInit {
  ...
  payment(): void {
    if (
      ...
      this.checkoutService.showMessage(`Payment is sucessfully, good choise! Confirm order: to ${this.client.address} by ${this.client.name}`, true);
      this.route.navigate(['../list-films']); 
    }    
  }
